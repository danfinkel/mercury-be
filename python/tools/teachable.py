...
class Teachable_Turbo4(Turbo4):
    ...
    #     Considers enhancing the message with a memo.
    #     """
    #     print(f"i was asked to add_message({message})")
    #     print("i am going to consider enhancing it with a memo")

    #     new_user_text = self.consider_memo_retrieval(message)
    #     print(f"i am going to add_message({new_user_text})")

    #     self.local_messages.append(new_user_text)
    #     self.client.beta.threads.messages.create(
    #         thread_id=self.current_thread_id, content=new_user_text, role="user" # type: ignore
    #     )
    #     if refresh_threads:
    #         self.load_threads()
